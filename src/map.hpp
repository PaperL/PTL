...
namespace sjtu {
    ...
    public:
         ...
         */
        typedef pair<const Key, T> Element;
    ...
    private:
        ...
        struct Node {
            ...
            Node(const Element &ele = nullptr, nodeColorENUM col = BLACK)
                    : element(ele), color(col), lChild(nullptr), rChild(nullptr), parent(nullptr) {}
